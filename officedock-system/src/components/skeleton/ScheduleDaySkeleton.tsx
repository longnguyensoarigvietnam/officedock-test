      ...
      <div className="flex-1 grid grid-rows-[repeat(auto-fill,_60px)]">
        {Array.from({
          ...
          <div key={hourIndex} className="flex">
            <div className="w-16 h-[60px] relative top-[28px] bg-[#E6F3FB] flex items-center justify-center ">
            ...
            {Array.from({ length: numberOfResources }).map(
              (_, resourceIndex) => (
                <div
                  key={resourceIndex}
                  className="flex-1 h-full border-b border-gray-300 bg-[#E6F3FB] bg-[linear-gradient(100deg,_#ffffff00_40%,_#ffffff80_50%,_#ffffff00_60%)] bg-[length:200%_100%] animate-[loadingShimmer_1s_ease-in-out_infinite]"
