    ...
    <div className={`relative h-full ${className}`} ref={dropdownRef}>
      ...
      <div
        ...
        <div className="h-full">
          <div
            className={`${valueClassName} h-full flex relative w-full cursor-default rounded border bg-white py-2.5  leading-5.5 pl-3 pr-10 text-left shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm ${
