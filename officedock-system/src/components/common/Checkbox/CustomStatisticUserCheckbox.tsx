    ...
    <div
      ...
      <div className="flex h-6 items-center">
        <input
          ...
          name={id}
          type="checkbox"
          className={`h-4 w-4 rounded !border-[#77858F] checked:border-none focus:outline-none focus:shadow-sm focus:border-focus focus:ring-0 focus:ring-offset-0 ${disable && 'cursor-not-allowed'} ${classSize}`}
          checked={checked}
          disabled={disable}
