  ...
  ({
    ...
    return (
      <Modal
        ...
        className={`font-primary bg-white ${isTweetSubmitted && isSendTweetSuccess ? 'w-[400px]' : 'w-[500px]'} !rounded-[20px] !py-10`}
        onClose={() => {}}>
        {isTweetSubmitted && isSendTweetSuccess ? (
          <div className="flex flex-col items-center space-y-3">
            <p className="text-sm leading-none">つぶやきました</p>
            <Button variant="text" className="pb-0 !text-[13px] !leading-none" onClick={onClose}>
              閉じる
            </Button>
          </div>
        ) : (
          <div className="flex flex-col items-center gap-[30px]">
            <div className="space-y-4">
              <p className="font-medium text-[18px] text-black leading-none">
                いまの気持ちをつぶやきましょう
              </p>
              <p className="text-[#77858F] text-sm font-medium leading-none">
                ※つぶやきはタイムラインに表示されます
              </p>
            </div>
