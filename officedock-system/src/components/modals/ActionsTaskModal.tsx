...
const ActionsTaskModal = ({
  ...
  const [_dataOptionsPriority, setDataOptionsPriority] = useState<
    OptionDropdownType[]
  >([]);
  ...
  useEffect(() => {
    ...
    dataOptionsPeopleInCharge,
    dataOptionsTagIds,
    selectedPersonInChargeOptions,
    selectedTagIdsOptions,
  ]);
  ...
  useEffect(() => {
    if (creationDataTaskData) {
      ...
      setDataOptionsPriority(
        creationDataTaskData.priorities.map((org) => ({
          label: org,
          value: org,
        })),
      );
  ...
  useEffect(() => {
    if (dataTask) {
      ...
      if (dataTask.tags && dataTask.tags.length) {
        dataTask.tags.map((element) =>
          appendProject({
            label: element.name,
            value: element.id,
          }),
  ...
  }, [append, appendPlanField, appendProject, dataTask, peopleDefaultId]);
  useEffect(() => {
  ...
  useEffect(() => {
    if (dataTask && dataTask.tags) {
      setSelectedTagIdsOptions(
        dataTask.tags.map((org) => ({
          label: org.name,
          value: org.id,
        })),
      );
    ...
    <Drawer
      ...
      <header className="px-8 rounded-tl-xl h-[50px] bg-[#EBF1F4] flex items-center justify-between">
        <div className="flex text-sm items-center gap-4 text-[#A3B3BE]">
          ...
          <div className=" h-3 mt-[2px] border-solid  border border-[#A3B3BE]"></div>
          <p className="">
            実施時間{' '}
      ...
      <form
        ...
        <div className="text-xs font-normal flex flex-col gap-4">
          ...
          <div
            ...
            <div className="w-full max-w-[515px] items-start flex gap-1">
                ...
                <div className="flex gap-1">
                  ...
                  <div className="w-[72px] relative z-20">
                    <Input
                      ...
                      disabled={
                        isCheckActionPermission ||
                        watch('statusId')?.value === StatusValueTask.MY_ROUTINE
                      }
                      ...
                      <div className="flex gap-1">
                              ...
                              return (
                                <DatePickerCustom
                                  ...
                                  onChange={(e) => {
                                    ...
                                    if (
                                      !getValues(`plans.${index}.planStartTime`)
                                    ) {
                                      setValue(
                                    ...
                                    setValue(`plans.${index}.planEndTime`, '');
                                  }}
                                />
                              );
                            }}
                        ...
                        <div className="w-[72px] relative">
                          <Input
                            ...
                            autoFocus={false}
                            disabled={isCheckActionPermission}
                            register={register(`plans.${index}.planStartTime`, {
                              required:
                                watch(`plans.${index}.planStartDate`) !== null
                                  ? true
                                  : false,
                              onChange: (e) => {
                                ...
                                if (
                                  ...
                                  setValue(`plans.${index}.planEndDate`, null);
                                  setValue(`plans.${index}.planEndTime`, '');
                            ...
                            options={optionTimeInput}
                            onChangeDropdown={(e) => {
                              setValue(`plans.${index}.planStartTime`, e.label);
                              if (
                                getValues(`plans.${index}.planStartDate`) ===
                                null
                              ) {
                        ...
                        <div className="w-[72px] relative">
                          <Input
                            ...
                            onChangeDropdown={(e) => {
                              ...
                              if (
                                getValues(`plans.${index}.planEndDate`) === null
                              ) {
                                if (
                                  getValues(`plans.${index}.planStartDate`) !==
                                  null
                    ...
                    <div>
                      {!isCheckActionPermission && (
                        <Button
                          sz="sm"
                          variant="outline"
                          className="w-[48px] h-[34px] hover:opacity-70 !border-none !px-0 !rounded-md text-[13px] !bg-[#DFE6EA]"
                          type="button"
                          name="Remove plan"
                          onClick={() => {
