...
export type ConfirmDragModalTaskProps = {
  open: boolean;
  name?: string;
  message?: string;
  userColor?: string;
...
const ConfirmDragModalTask = memo(
  ({
    open,
    name,
    userColor,
    ...
    return (
      <Modal
        ...
        <div className="text-center mb-10">
          <p className="text-sm text-black leading-6 text-neutral-02">{`このタスクカードの完了を取り消しますか？`}</p>
...
export default ConfirmDragModalTask;
