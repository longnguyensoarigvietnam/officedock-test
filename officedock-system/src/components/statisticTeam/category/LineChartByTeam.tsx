...
const LineChartByTeam = ({
  ...
  useEffect(() => {
    if (!statisticUserTaskDurationsList) return;
  ...
  useEffect(() => {
    if (!statisticUserTaskDurationsList?.length) return;
  ...
  const columns: ColumnDef<TableRowDetail>[] = [
        ...
        return (
          <div className="flex items-start px-[18px]">
            ...
            <div className="w-full">
              <div
                className={`flex justify-between items-center w-full ${collapseStatus && 'mb-3'}`}>
                      ...
                      return (
                        <div
                          ...
                          <CustomUserAvatar
                            ...
                            size={24}
                          />
                          <p className="text-sm font-medium max-w-full break-all line-clamp-1 text-left">
                            {user.userName}
                          </p>
                        </div>
                      );
      ...
      cell: (info) => {
        ...
        return (
          <div className="flex flex-col font-medium text-[14px] text-black px-[18px]">
            <div className={`flex justify-center ${collapseStatus && 'mb-3'}`}>
    ...
    },
    {
      ...
      cell: (info) => {
        ...
        return (
          <div className="flex flex-col font-medium text-[14px] text-black px-[18px]">
            <p className={`flex justify-center ${collapseStatus && 'mb-3'}`}>
              {Math.round(value)}%
            </p>
            {collapseStatus &&
              info.row.original?.userList &&
