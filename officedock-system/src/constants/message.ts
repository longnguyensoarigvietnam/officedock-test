...
export const LEVEL_NUMBER_REQUIRED_MESSAGE = '入力してください。';
...
export const END_DATE_WRONG_SELECTED =
  '終了時刻を開始時刻より後に設定してください。';
export const END_DATE_REQUIRED_SELECTED =
  '終了時刻を開始時刻より後に設定してください。';

export const START_DATE_REQUIRED_SELECTED = '実施予定日時を設定してください。';
...
export const ERROR_NOT_FOUND_SKILL_MAP = 'スキルマップが見つかりません。';
