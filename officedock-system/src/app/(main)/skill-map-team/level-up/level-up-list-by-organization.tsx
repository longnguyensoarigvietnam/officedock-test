...
export const LevelUpListByOrganization = ({
  ...
  return (
    <div
      className="w-full p-[30px] bg-[#F8FAFC] rounded-[30px] mb-5"
      ...
      {orgSubmitLevel.submitLevels.length == 0 ? (
        ...
        <div>
          {/* Header */}
          <div className="flex text-xs mb-[14px] text-[#77858F] font-medium">
          ...
          <div className="flex flex-col gap-[14px]">
            {orgSubmitLevel.submitLevels.map((submitLevel) => {
              return (
                <div
                  key={submitLevel.id}
                  className="bg-white py-[20px] rounded-[14px]"
                  style={{
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="w-[calc((100%_-_433px)/6)] px-3 flex items-center gap-2">
                      <CustomUserAvatar
                    ...
                    <div className="w-[calc((100%_-_433px)/3)] px-3">
                    ...
                    <div className="w-[calc((100%_-_433px)/2)] px-3">
