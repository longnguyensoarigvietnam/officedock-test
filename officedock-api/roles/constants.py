...
DEPARTMENT_MANAGER_PERMISSIONS = {
    ...
    Screens.ACTUAL_DURATION.value: ALLOWED_FULL_ACTIONS,  # FIXME: Change to ONLY_DATA_ORGANIZATION_ACTIONS
...
GENERAL_PERMISSIONS = {
    ...
    Screens.TEAMDOCK.value: ONLY_DATA_ORGANIZATION_ACTIONS,
    Screens.ACTUAL_DURATION.value: ALLOWED_FULL_ACTIONS,  # FIXME: Change to NOT_ALLOWED_ACTIONS
