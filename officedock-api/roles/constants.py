...
SYSTEM_ADMIN_AND_MANAGER_PERMISSIONS = {
    ...
    Screens.TEAM_STATISTIC.value: ALLOWED_FULL_ACTIONS,
    Screens.TEAM_TASK.value: ALLOWED_FULL_ACTIONS,
...
DEPARTMENT_MANAGER_PERMISSIONS = {
    ...
    Screens.TEAM_STATISTIC.value: ALLOWED_VIEW_ORGANIZATION_ACTIONS,
    Screens.TEAM_TASK.value: ONLY_DATA_ORGANIZATION_ACTIONS,
