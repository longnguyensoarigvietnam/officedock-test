...
_ERROR_MESSAGES = {
    "en": {
        ...
        "cannot_edit_duration": _("This duration is cannot edit."),
        ...
        "organization_linked_to_task": _(
            "This organization {name} is linked to a task and cannot be deleted."
        ),
        # Survey
    ...
    "ja": {
        ...
        "last_system_admin_deleted": _("管理者が最低1人はシステム上に存在する必要があります。"),
        "last_operation_admin_deleted": _("管理者が最低1人はシステム上に存在する必要があります。"),
        "last_system_admin_role_change": _("管理者が最低1人はシステム上に存在する必要があります。"),
        ...
        "organization_linked_to_task": _("{name}はタスクに紐づいているため、削除できません。"),
        # Survey
