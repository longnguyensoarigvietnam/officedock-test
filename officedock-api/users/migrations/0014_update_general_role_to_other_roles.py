# Generated by Django 5.0.6 on 2025-04-12 10:03
...
def seed_data_role_permission_by_new_sreens(apps, schema_editor):
    """Seed data role permissions"""
    Permission = apps.get_model("users", "Permission")
    RoleDetail = apps.get_model("users", "RoleDetail")
    Role = apps.get_model("users", "Role")

    # Clean role details and permissions
    RoleDetail.objects.all().delete()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("users", "0013_seed_data_role_permissions_by_new_sreens"),
    ]

    operations = [
        migrations.RunPython(
            seed_data_role_permission_by_new_sreens,
