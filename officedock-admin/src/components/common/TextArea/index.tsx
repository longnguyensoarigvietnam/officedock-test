  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div
        ...
        <textarea
          className={`w-full px-3.5 h-32 py-2.5 leading-5.5 placeholder-gray-300 border rounded-lg focus:outline-none focus:shadow-sm focus:border-focus focus:ring-0 ${disabled && 'opacity-55'} ${errorClasses} ${className}`}
          disabled={disabled}
          {...props}
          {...register}
        />
